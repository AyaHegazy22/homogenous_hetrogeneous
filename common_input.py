...
triso_pf = 0.53690335969                        # TRISO packing fraction (%), 1.34225839923 is a result of adding the sixth graphite layer
...
graphite_radius = 535.0e-6             # graphite layer outer radius (m)
